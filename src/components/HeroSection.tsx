...
const HeroSection = () => {
  return (
    <section className="relative min-h-screen flex items-center overflow-hidden pt-20">
      ...
      <img src={orbImage} alt="" className="absolute top-32 right-10 w-16 h-16 animate-float opacity-60 hidden lg:block" />
      <img src={orbImage} alt="" className="absolute bottom-40 left-10 w-10 h-10 animate-float opacity-40 hidden lg:block [animation-delay:2s]" />
      ...
      <div className="container mx-auto px-6 grid lg:grid-cols-2 gap-12 items-center relative z-10">
        <div className="space-y-8 animate-slide-up">
          ...
          <div className="flex flex-wrap gap-4">
            <a href="#" className="group px-8 py-4 bg-primary text-primary-foreground font-display font-semibold rounded-2xl glow-purple hover:opacity-90 transition-all inline-flex items-center gap-2">
              Get Started Free →
            </a>
            <a href="#" className="px-8 py-4 glass-card gradient-border text-foreground font-display font-semibold rounded-2xl hover:bg-secondary/50 transition-colors inline-block">
              Watch Demo
            </a>
          </div>
        ...
        <div className="relative flex justify-center animate-slide-up [animation-delay:0.2s]">
          <div className="relative">
            ...
            <img src={heroImage} alt="Game management dashboard with controller" className="relative w-full max-w-lg rounded-3xl" />
          </div>
        </div>
      </div>
    </section>
